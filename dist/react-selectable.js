...
var _createSelectable = __webpack_require__(23);
...
var _doObjectsCollide = __webpack_require__(20);
...
var SelectableGroup = function (_Component) {
  ...
  function SelectableGroup(props) {
    ...
    _this.selectionBoxRef = (0, _react.createRef)();
  ...
  _createClass(SelectableGroup, [{
    ...
    value: function _selectElements(e) {
      ...
      var _selectBox = this.selectionBoxRef.current;
    ...
    value: function render() {
      var _props3 = this.props,
          ...
          onBeginSelection = _props3.onBeginSelection,
          onEndSelection = _props3.onEndSelection,
          onSelection = _props3.onSelection,
          tolerance = _props3.tolerance,
          dragTolerance = _props3.dragTolerance,
          preventDefault = _props3.preventDefault,
          onNonItemClick = _props3.onNonItemClick,
          restProps = _objectWithoutProperties(_props3, ["children", "enabled", "fixedPosition", "className", "selectingClassName", "component", "onBeginSelection", "onEndSelection", "onSelection", "tolerance", "dragTolerance", "preventDefault", "onNonItemClick"]);
      ...
      return _react2.default.createElement(
        ...
        isBoxSelecting ? _react2.default.createElement(
          "div",
          { style: boxStyle, ref: this.selectionBoxRef },
...
SelectableGroup.propTypes = {
   ...
   * @type {Number}
   */
  dragTolerance: _propTypes2.default.number,
...
var createSelectable = function createSelectable(WrappedComponent) {
  var SelectableItem = function (_React$Component) {
    ...
    _createClass(SelectableItem, [{
      ...
      value: function render() {
        var _props = this.props,
            selectableKey = _props.selectableKey,
            selectableItemProps = _props.selectableItemProps;
